...
# The information of table in Figure 2 (a) which is also the data needed to plot Figure 2 (b) by Maple in the file "Maple_5_Example_HK_1v_2p_Figure_2.mw" is from the following computation.

# We ask Julia to write the report on a txt file as well.
filename="Output_5_Example_HK_1v_2p_Figure_2"
